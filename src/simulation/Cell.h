...
class Cell : public Agent {
 public:
  ...
  bool get_death() final {return death_;}
  double get_proba_survival() final {return proba_survival_;}
  bool check_for_death(double current_time, double dt) final;
  void update_survival_probability();
